...
C {devices/lab_pin.sym} 640 -490 0 1 {name=p1 sig_type=std_logic lab=Z}
C {devices/lab_pin.sym} 80 -530 0 0 {name=p5 sig_type=std_logic lab=A}
C {devices/lab_pin.sym} 180 -450 0 0 {name=p3 sig_type=std_logic lab=B}
C {devices/vsource.sym} 80 -360 0 0 {name=V3 value=3.1 savecurrent=false}
C {devices/vsource.sym} 180 -360 0 0 {name=V1 value=3 savecurrent=false}
C {devices/code_shown.sym} 230 -320 0 0 {name=COMMANDS1 only_toplevel=false value="
...
.endc
"}
C {devices/lab_pin.sym} 60 -290 0 0 {name=p4 sig_type=std_logic lab=0}
C {devices/title.sym} 140 -40 0 0 {name=l1 author="Phillip Baade-Pedersen"}
C {devices/launcher.sym} 610 -200 0 0 {name=h2
descr="OP annotate" 
tclcommand="xschem annotate_op"
}
C {devices/launcher.sym} 610 -160 0 0 {name=h1
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_diff_amp.raw dc"
}
C {schematics/diff_amp.sym} 420 -490 0 0 {name=U1 model=diff_amp_cell spiceprefix=X}
