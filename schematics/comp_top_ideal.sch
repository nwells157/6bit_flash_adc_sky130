...
C {devices/lab_pin.sym} 210 -320 0 0 {name=p7 sig_type=std_logic lab=vref[62..0]}
C {devices/lab_pin.sym} 210 -340 0 0 {name=p6 sig_type=std_logic lab=VIN}
C {devices/lab_pin.sym} 370 -460 0 0 {name=p8 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 520 -330 0 1 {name=p10 sig_type=std_logic lab=vout[62..0]}
